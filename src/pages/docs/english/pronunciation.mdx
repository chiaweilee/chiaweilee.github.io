...
- <Speak>fleece</Speak> /fliːs/
- <Speak>sea</Speak> /siː/
- <Speak>machine</Speak> /məˈʃiːn/

## /iː/ and /ɪ/

- <Speak>litre</Speak> /ˈliːtə/, <Speak>litter</Speak> /ˈlɪtə/
- <Speak>cheap</Speak> /tʃiːp/, <Speak>chip</Speak> /tʃɪp/
- <Speak>feet</Speak> /fiːt/, <Speak>fit</Speak> /fɪt/
- <Speak>he's</Speak> /hiːz/, <Speak>his</Speak> /hɪz/
- <Speak>peach</Speak> /piːtʃ/, <Speak>pitch</Speak> /pɪtʃ/
- <Speak>sheep</Speak> /ʃiːp/, <Speak>ship</Speak> /ʃɪp/
